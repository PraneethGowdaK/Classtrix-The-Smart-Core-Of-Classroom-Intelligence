...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    ...(isAdmin ? [
      { icon: GraduationCap, label: "Manage Courses", href: "/subjects" },
      ...
      { icon: Brain, label: "Manage ML Models", href: "/ml-models" },
      ...
      >
        <div className="flex flex-col h-full w-64">
          <div className="p-4 flex items-center gap-4">
            <Button variant="ghost" size="icon" onClick={toggleSidebar} className="shrink-0 !border !border-black dark:!border-white">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        <header className="h-14 border-b bg-card flex items-center px-4 md:px-6 shrink-0 gap-4">
          <Button 
            ...
            className={cn("shrink-0 !border !border-black dark:!border-white", window.innerWidth >= 768 && "hidden")}
          >
            <Menu className="h-5 w-5" />
          </Button>
