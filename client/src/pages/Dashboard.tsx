...
import { Calendar, CheckCircle2, BarChart3, Camera, Users, Database, BookOpen, GraduationCap, Brain } from "lucide-react";
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className={`grid grid-cols-1 ${currentUser?.role === 'teacher' ? 'md:grid-cols-4' : currentUser?.role === 'admin' ? 'md:grid-cols-3 lg:grid-cols-6' : 'md:grid-cols-2'} gap-6`}>
        ...
        {currentUser?.role === 'admin' && (
          <>
            <Link href="/subjects">
              <Card className="hover:bg-muted/50 cursor-pointer transition-all duration-200 group border-2 border-transparent hover:border-purple-500/20 hover:scale-[1.02] active:scale-[0.98]">
                <CardContent className="p-6 flex flex-col items-center text-center gap-4">
                  <div className="h-12 w-12 rounded-full bg-purple-500/10 flex items-center justify-center text-purple-600 group-hover:scale-110 transition-transform">
                    <GraduationCap className="h-6 w-6" />
                  </div>
                  <div>
                    <h3 className="font-bold uppercase text-sm">Manage Courses</h3>
                  </div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/ml-models">
              <Card className="hover:bg-muted/50 cursor-pointer transition-all duration-200 group border-2 border-transparent hover:border-blue-500/20 hover:scale-[1.02] active:scale-[0.98]">
                <CardContent className="p-6 flex flex-col items-center text-center gap-4">
                  ...
                  <div>
                    <h3 className="font-bold uppercase text-sm">Manage ML Models</h3>
                  </div>
                </CardContent>
              </Card>
            </Link>
